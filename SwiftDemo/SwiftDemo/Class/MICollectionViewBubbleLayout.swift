...
open class MICollectionViewBubbleLayout: UICollectionViewFlowLayout {
    ...
    fileprivate var effectiveHorizontalAlignment: EffectiveHorizontalAlignment {
        ...
        @unknown default:
            fatalError("not set rightToLeft")
        }
...
fileprivate extension UICollectionViewLayoutAttributes {
    ...
    func isRepresentingFirstItemInLine(collectionViewLayout: MICollectionViewBubbleLayout) -> Bool {
        if currentItem <= 0 {
            return true
        }
        else {
    ...
    func isRepresentingLastItemInLine(collectionViewLayout: MICollectionViewBubbleLayout) -> Bool {
    ...
    private func alignToPrecedingItem(collectionViewLayout: MICollectionViewBubbleLayout) {
    ...
    ///
    /// - Parameter collectionViewLayout: The layout on which to perfom the calculations.
    private func alignToFollowingItem(collectionViewLayout: MICollectionViewBubbleLayout) {
        let itemSpacing = collectionViewLayout.minimumInteritemSpacing
    ...
    func alignHorizontally(collectionViewLayout: MICollectionViewBubbleLayout) {
    ...
    func alignVertically(collectionViewLayout: MICollectionViewBubbleLayout) {
